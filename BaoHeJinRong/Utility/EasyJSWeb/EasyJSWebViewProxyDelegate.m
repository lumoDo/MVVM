...
- (void)webViewDidFinishLoad:(UIWebView *)webView{
    ...
    //调用H5传参JS方法;
    [webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"onSetKnowChannel('%@');",KNOWCHANNEL]];
    [webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"onSetAppVersion('%@');",APPVERSION]];
